...
class Checkout extends Component {
	...
	render() {
        ...
        const { email, shippingAddress, cardName, cardNumber, CVV, year, month} = this.state
                        ...
                        <form onSubmit={this.handleSubmit}>
                            <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    name="address" type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter address"/>
                                </div>            
                                ...
                                <div className="form-group">
                                    ...
                                    name="cardName" type="cardName" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter card name"/>
                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    name="cardNumber" type="number" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Card Number"/>
                                </div>
                                ...
                                <div className="form-group col-sm-4" style={{paddingLeft:"0px", display:"inline-block"}}>            
                                    ...
                                    name="cvv" type="number" className="form-control" id="cvv" placeholder="Security Code"/>
                                </div>
                                <div className="form-group col-sm-offset-5 col-sm-6" style={{paddingLeft:"0px", float:"right", display:"inline-block"}}>            
                                    ...
                                    <div className="row" style={{marginLeft:"0px"}}>
                                        ...
                                        name="cardYear" type="text" className="form-control" id="year" placeholder="YYYY" 
                                        style={{width:"40%", display:"inline-block", marginRight:"10px"}}/>
                                        <input 
                                        onChange={(event) => this.setState({month: event.target.value})}
                                        name="cardMonth" type="text" className="form-control" id="month" placeholder="MM" style={{width:"40%", display:"inline-block"}}/>
                                    </div>
